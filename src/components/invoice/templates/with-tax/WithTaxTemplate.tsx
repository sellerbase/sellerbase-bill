...
export default function WithTaxTemplate({ 
  items,
  onRemoveItem,
  onUpdateItems,
  ...
  const {
    ...
    inputBaseStyle,
    renderDraggableItem,
  } = useInvoiceTemplate(items, onUpdateItems, onRemoveItem, 'with-tax');
  ...
  const columns = [
    ...
    { type: 'taxRate' as const, label: '税率', width: 50 },
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      {/* ヘッダー */}
      <div className="grid gap-1 items-center px-2 py-2 border-b border-gray-200 bg-gray-50"
